      ...
      <div className="shell grid gap-10 py-14 md:grid-cols-3">
        <div>
          ...
          <p className="mt-3 max-w-xs text-sm leading-relaxed text-muted">
            Modern digital skills training — live online from Dubai across the UAE.
          </p>
          <p className="mt-3 text-sm text-muted">{site.location.label}</p>
        </div>

        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-faint">Links</p>
        ...
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-faint">Contact</p>
